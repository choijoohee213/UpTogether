...
namespace UpTogether.EditorTools
{
    ...
    {
        /// 캐릭터 스프라이트의 PPU. 강아지와 주인공이 같은 값을 써야
        /// 아트가 의도한 상대 크기가 유지된다 (시트 메타의 요구사항).
        ///
        /// 100 = 텍스처 1px 이 프로토타입 1px. 주인공 몸통 50~56px 이 0.50~0.56유닛이 된다.
        /// 프로토타입 주인공이 44px 이었으니 그보다 조금 크다.
        /// 발판 간격(0.68~1.02유닛)보다 작으니 시각적으로도 무리가 없고,
        /// 충돌은 발밑 점 하나로만 보기 때문에 물리에는 아무 영향이 없다.
        public const float CharacterPixelsPerUnit = 100f;
